    ...
    <main class="container-fluid">
        ...
        <form action="jogo-cadastrar2.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="input-input" type="text" name="nome" required maxlength="200" placeholder="Digite o nome do jogo" autofocus>
                <?php
            ...
            <div class="form-group">
                ...
                <input type="number" step=".01" min="0" max="9999999" placeholder="Preço" name="preco" id="input-preco" required>
            </div>
        ...
        <a href="administrador.php">Retornar</a>
