...
<body>
    ...
    <main class="container-fluid">
        ...
        <a href="adm-consulta.php" class="btn btn-primary">consultar por nome(altarar/excluir)</a>
        ...
        <h1>Jogadores</h1>
        <hr>
        <a href="jogador-cadastro1.php" class="btn btn-primary">cadastrar</a>
        <a href="jogador-lista.php" class="btn btn-primary">listar todos</a>
        <a href="jogador-consulta.php" class="btn btn-primary">consultar por nome(altarar/excluir/carrinhos)</a>
        ...
        <a href="jogo-consulta.php" class="btn btn-primary">consultar por nome(altarar/excluir/Registros de compras)</a>
        <a href="jogo-alterar1.php" class="btn btn-primary">alterar(por ID)</a>
        <a href="jogo-exclui1.php" class="btn btn-primary">excluir(por ID)</a>
        <br><br><br><br>
