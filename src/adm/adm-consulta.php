...
<body>
    ...
    <main class="container-fluid">
        ...
        <form action="adm-consulta.php" method="get">
            ...
            <input type="text" name="nome" value="<?php if(isset($_GET['nome'])){echo $_GET['nome'];} ?>" id="nome-adm">
        ...
        ?>
            ...
            <table class='table table-striped'>
                ...
                for ($i = 0; $i < sizeof($dados); $i++) {
                    ...
                    echo "<td><a href class='btn btn-outline-primary'='adm-alterar2?id=" . $dados[$i]['pk_id_adm'] . " '>Alterar dados</a></td>";
                    echo "<td><a href class='btn btn-outline-danger'='adm-excluir2.php?id=" . $dados[$i]['pk_id_adm'] . " '>Excluir</a></td>";
                    echo "</tr>";
                }
                ?>
            </table>
