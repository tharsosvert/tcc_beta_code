        ...
        ?>
            ...
            <table>
                ...
                for ($i = 0; $i < sizeof($dados); $i++) {
                    ...
                    echo "<td><a href='jogador-alterar2?id=" . $dados[$i]['pk_id_jogador'] . " '>Altarar dados</a></td>";
                    echo "<td><a href='jogador-exclui2?id=" . $dados[$i]['pk_id_jogador'] . " '>Excluir</a></td>";
                    echo "<td><a href='jogador-carrinhos?id=" . $dados[$i]['pk_id_jogador'] . " '>Carrinhos do jogador</a></td>";
                    echo "</tr>";
                }
                ?>
            </table>
